...
//AVATAR
const jeffTexture=new THREE.TextureLoader().load('https://www.thestreet.com/.image/t_share/MTgyMDU5NDcwMTc4NzU1NzE1/boredape1.jpg')
const jeff=new THREE.Mesh(

  new THREE.BoxGeometry(3,3,3),new THREE.MeshBasicMaterial({map:jeffTexture})
);
...
scene.add(moon)
moon.position.z=30;
moon.position.setX(-10) // or moon.position.x=-10 (that is a setter function)
camera.position.z=9
